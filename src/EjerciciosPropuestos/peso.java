/***
 * PROGRAMA DE CONVERSOR DE UNIDADES DE PESO
 *** 
...
public class peso {
	/*ALEJANDRO, EL EJERCICIO ME COMPILA Y ME FUNCIONA SIN NINGUN PROBLEMA,
	SIN EMBARGO, AL COMPILARLO, ME OBLIGA A METER 2 VECES EL VALOR NUMERICO
	DEL PESO QUE SE TIENE QUE PASAR PRIMERO A KILOGRAMOS, POR ESE MOTIVO
	HE IMPLEMENTADO LA SEGUNDA LINEA DE TEXTO QUE APARECE EN LA CONSOLA QUE 
	DICE QUE VUELVA A INTRODUCIR EL VALOR NUMERICO, NO ENTIENDO EL PORQUE OCURRE ESTO
	PERO HE TENIDO QUE DEJARLO ASI YA QUE NO ENCONTRABA EL MOTIVO.
	*/
